...
public class GmailReader {
	private static final String EMAIL = "sunitamydream38@gmail.com";
	private static final String APP_PASSWORD = "suka hvlo ugad ellz";
	public static String readMessagesFromGmail() {
		Store store = null;
		Folder folder = null;
        String msg=null;
		try 
...
//			}
			...
			if (messages.length > 0) 
			{
				...
				msg=printMessage(recentMessage);
			}
